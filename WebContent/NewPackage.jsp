...
<script type="text/javascript">
			...
			$(document).ready( function() {
				...
				$('#fileTreeDemo_1').fileTree({ root: path, script: 'jqueryFileTree.jsp' }, function(file) { 
					...
					document.getElementById("dir").value=file.substring(n+10);
				});				
			});
		</script>
<div class="row">
...
<br><br><h1>New Package</h1><br>
			<div class="input-group">
			<%File f=new File(getServletContext().getRealPath("/Directory/")+session.getAttribute("user").toString()); 
				if(!f.exists()){
					f.mkdir();
				}
			%>
		<form action="NewPackage2.jsp" method="POST">
		<label style="color:white;">Select Parent Package:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" name="dir" id="dir" value='.'></input>
		<br/>
		<div class="example">
		...
		%>
				...
				<br/>
	<label style="color:white;">Enter Package Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> 
	<input type="text" name="pac" id="pac"/><br/>
	<button type="submit" class="btn btn-success" style="background:white; color:#18bc9c">Create</button>				
		</form>
			</div>
			</div>
			</div>
