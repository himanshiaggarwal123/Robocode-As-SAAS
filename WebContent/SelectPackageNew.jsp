...
<script type="text/javascript">
			...
			$(document).ready( function() {
				...
				$('#fileTreeDemo_1').fileTree({ root: path, script: 'jqueryFileTree.jsp' }, function(file) { 
					...
					document.getElementById("dir").value=file.substring(n+11);
				});				
			});
		</script>
<div class="row">
...
<br><br><h1>Package</h1><br>
			...
			%>
		<form action="NewRobot.jsp" method="POST">
	...
	<button type="submit" class="btn btn-success" style="background:white; color:#18bc9c">Select</button>	</form>
	<form action="NewPackage.jsp">
		<button type="submit" class="btn btn-success" style="background:white; color:#18bc9c">Create New</button>				
