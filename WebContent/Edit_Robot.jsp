...
<!--  <body id="page-top" class="index">
	...
	<script type="text/javascript">
	function New(){
		window.location.replace("NewRobot.jsp"); 
 	}
	function Edit(){
		window.location.replace("Edit_Robot.jsp"); 
 	}
	function View(){
		window.location.replace("ViewRobot.jsp"); 
 	}
	</script>
	<div class="dropdown">
...
<script type="text/javascript">
	...
	function SelectAll(){
		...
		<ul class="dropdown-menu">
			...
			<li onclick="Redo();"><a href="#Redo">Redo</a></li>
			<li><a href="#Copy">Copy</a></li>
			<li><a href="#Paste">Paste</a></li>
			<li onclick="SelectAll();"><a href="#SelectAll">Select All</a></li>
		</ul>
	</div>
	<div class="dropdown">
	...
	<div class="row">
		...
		System.out.println("In Edit_Robot.jsp: "+ roleName);
		Class.forName(driverClassName).newInstance();;
		Connection connection = DriverManager.getConnection(connectionUrl,dbUser,dbPwd);
									Statement statement = connection.createStatement();
									String selectString="SELECT userID, packageID, robotID, StorageDirPath from robot where id in (SELECT robotId from robot_role where role='"+ roleName +"') or userId='"+session.getAttribute("user").toString()+"';";
									resultset = statement
						...
						<select name="domain_name" id="domain_name" class="form-control" onchange="getDomains()"
							...
							<%
									while (resultset.next()) {
										...
										list_of_storageDirs.add(resultset.getString(4));
										...
										if (value == null) {
											...
											map.get(value1).add(value4);
										} else {
											value = map.get(value1);
											if (!value.contains(value4)) {
												map.get(value1).add(value4);
											}

										}
										value = domain_robot_map.get(value4);
										if (value == null) {
											domain_robot_map.put(value4, new ArrayList<String>());
											domain_robot_map.get(value4).add(value3);
										} else {
											value = domain_robot_map.get(value4);
