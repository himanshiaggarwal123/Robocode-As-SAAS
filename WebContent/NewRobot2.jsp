...
<%
	...
	String rname =(String) session.getAttribute("roboname");
	String username = (String) session.getAttribute("user");
	String packName = (String)session.getAttribute("package");
	String dpath = (String)session.getAttribute("DirPath");
	System.out.println(robotname +" "+packageName+ " "+ objRobot.getStoragePath() + " "+ username + " "+ packName + " "+rname);
%>
