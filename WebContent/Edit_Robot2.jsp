						...
						<%
							...
							HashMap<String, List<String>> domain_robot_map = new HashMap<String, List<String>>();							
								try {
									...
									String selectString="SELECT userID, packageID, robotID,StorageDirPath from robot where id in (SELECT robotId from robot_role where role='"+ roleName +"');";
									resultset = statement
