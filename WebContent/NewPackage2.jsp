...
<br><br><h1>Package</h1><br>
			<div class="input-group">
			<%File f=new File(getServletContext().getRealPath("/Directory/")+request.getParameter("dir")+request.getParameter("pac")); 
			System.out.println(getServletContext().getRealPath("/Directory/")+request.getParameter("dir")+request.getParameter("pac"));	
			if(!f.exists()){
					f.mkdir();
